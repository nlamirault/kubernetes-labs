...
export SUBNETWORK_CIDR="10.40.0.0/20"
export SUBNETWORK_PODS_NAME="${APP}-subnetwork-pods"
export SUBNETWORK_PODS_CIDR="10.40.32.0/20"
export SUBNETWORK_SVC_NAME="${APP}-subnetwork-svc"
export SUBNETWORK_SVC_CIDR="10.40.16.0/20"
...
CILIUM_OPTIONS="--enable-network-policy"
# PRIVATE_GKE_OPTIONS="--enable-private-endpoint --enable-private-nodes --master-ipv4-cidr=${IPV4_CIDR_GKE_MASTER}"
export CLUSTER_OPTIONS="${COMMONS_OPTIONS} ${NETWORK_OPTIONS} ${MAINTENANCE_OPTIONS} ${CILIUM_OPTIONS} "
